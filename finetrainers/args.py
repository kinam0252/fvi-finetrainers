...
class Args:
    ...
    CREPA ARGUMENTS
    ---------------
    return_hidden_states (`List[str]`, defaults to None):
        List of hidden layers to return hidden states. Ex) 1,2 returns hidden state output of layer 1 and 2. 'all' returns all hidden states.
    """
    ...
    # crepa arguments
    return_hidden_states: List[str] = None
...
def _add_crepa_arguments(parser: argparse.ArgumentParser) -> None:
    parser.add_argument(
        "--return_hidden_states",
        type=str,
        default=None,
        help="List of hidden layers to return hidden states. Ex) 0,1 returns hidden state output of layer 0 and 1. 'all' returns all hidden states.",
    )
...
def _map_to_args_type(args: Dict[str, Any]) -> Args:
    ...
    # CREPA arguments
    result_args.return_hidden_states = args.return_hidden_states
